...
<div class="col-sm-3 col-md-2 sidebar">
	...
	<div class="drop-navigation drop-navigation">
		<ul class="nav nav-sidebar">
			...
			<li><a href="<c:url value='/shows'/>" class="user-icon"><span
					class="glyphicon glyphicon-home glyphicon-blackboard"
					aria-hidden="true"></span>Truyền Hình</a></li>
			<li><a href="<c:url value='/history'/>" class="sub-icon"><span
					class="glyphicon glyphicon-home glyphicon-hourglass"
					aria-hidden="true"></span>Lịch sử</a></li>
			<li><a href="#" class="menu1"><span
					class="glyphicon glyphicon-film" aria-hidden="true"></span>Phim<span
			...
			<li><a href="#" class="menu"><span
					class="glyphicon glyphicon-film glyphicon-king" aria-hidden="true"></span>Thể
					Thao<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
			<ul class="cl-effect-1">
				<li><a href="<c:url value='/sports/football'/>">Bóng đá</a></li>
				<li><a href="<c:url value='/sports/chess'/>">Cờ vua</a></li>
				<li><a href="<c:url value='/sports/voleyball'/>">Bóng
						chuyền</a></li>
			...
			<li><a href="<c:url value='/songs'/>" class="song-icon"><span
					class="glyphicon glyphicon-music" aria-hidden="true"></span>Bài Hát</a></li>
			<li><a href="<c:url value='/news'/>" class="news-icon"><span
					class="glyphicon glyphicon-envelope" aria-hidden="true"></span>Tin
					Tức</a></li>
		</ul>
		<!-- script-for-menu -->
		<script>
			...
			<div class="copyright">
				<p>
					Copyright © 2015 My Play. All Rights Reserved | Design by <a
						href="https://daa.uit.edu.vn/">UIT Student</a>
				</p>
			</div>
		</div>
	</div>
