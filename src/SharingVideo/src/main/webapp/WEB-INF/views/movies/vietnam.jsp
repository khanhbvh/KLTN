    ...
    <div class="show-top-grids">
		            	...
		            	<div class="col-md-3 resent-grid recommended-grid movie-video-grid">
	                        ...
	                        <div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">
	                            ...
	                            <ul>
	                                ...
	                                <li class="right-list"><p class="views views-info">${newestVideo.numView} views</p></li>
	                            </ul>
	                        </div>
	                    </div>
					</c:forEach>
            ...
            <div class="recommended">
                <div class="recommended-grids">
                    ...
                    <c:forEach var="topViewVideo" items="${map.topViewVideoList}">
		                <div class="col-md-3 resent-grid recommended-grid movie-video-grid">
	                        <div class="resent-grid-img recommended-grid-img">
	                            <a href="single.html"><img src="<c:url value="/resources/images/${topViewVideo.img}"/>" alt="" /></a>
	                            <div class="time small-time show-time movie-time">
	                                <p>2:34</p>
	                            </div>
	                            <div class="clck movie-clock">
	                        ...
	                        <div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">
	                            <h5><a href="single.html" class="title">${topViewVideo.title}</a></h5>
	                            <ul>
	                                <li><p class="author author-info"><a href="#" class="author">John Maniya</a></p></li>
	                                <li class="right-list"><p class="views views-info">${topViewVideo.numView} views</p></li>
	                            </ul>
	                        </div>
	                    </div>
					</c:forEach>
            ...
            <div class="recommended">
                <div class="recommended-grids">
                    ...
                    <c:forEach var="likeVideo" items="${map.likeVideoList}">
		                <div class="col-md-3 resent-grid recommended-grid movie-video-grid">
	                        <div class="resent-grid-img recommended-grid-img">
	                            <a href="single.html"><img src="<c:url value="/resources/images/${likeVideo.img}"/>" alt="" /></a>
	                            <div class="time small-time show-time movie-time">
	                                <p>5:32</p>
	                            </div>
	                            <div class="clck movie-clock">
	                        ...
	                        <div class="resent-grid-info recommended-grid-info recommended-grid-movie-info">
	                            <h5><a href="single.html" class="title">${likeVideo.img}</a></h5>
	                            <ul>
	                                <li><p class="author author-info"><a href="#" class="author">John Maniya</a></p></li>
	                                <li class="right-list"><p class="views views-info">${likeVideo.numView} views</p></li>
	                            </ul>
	                        </div>
	                    </div>
					</c:forEach>
        ...
        <div class="col-md-2 show-grid-right">
            ...
            <div class="show-right-grids">
                <ul>
                    <li class="tv-img"><a href="#"><img src="<c:url value="/resources/images/mv.png"/>" alt="" /></a></li>
