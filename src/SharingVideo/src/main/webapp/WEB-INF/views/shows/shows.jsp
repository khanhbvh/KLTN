						...
						<div class="col-md-2 resent-grid recommended-grid show-video-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="single.html"><img
									src="<c:url value="/resources/images/${popShow.img}"/>" alt="" /></a>
							...
							<div class="resent-grid-info recommended-grid-info">
								<h5>
									<a href="single.html" class="title">${popShow.title}</a>
								</h5>
								<p class="author">
				...
				<div class="recommended-grids">
					...
					<c:forEach var="vietShow" items="${map.vietShowList}">
						<div class="col-md-2 resent-grid recommended-grid show-video-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="single.html"><img
									src="<c:url value="/resources/images/${vietShow.img}"/>" alt="" /></a>
								<div class="time small-time show-time">
									<p>2:34</p>
								</div>
								<div class="clck show-clock">
							...
							<div class="resent-grid-info recommended-grid-info">
								<h5>
									<a href="single.html" class="title">${vietShow.title}</a>
								</h5>
								<p class="author">
									<a href="#" class="author">John Maniya</a>
								</p>
				...
				<div class="recommended-grids">
					...
					<c:forEach var="usShow" items="${map.usShowList}">
						<div class="col-md-2 resent-grid recommended-grid show-video-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="single.html"><img
									src="<c:url value="/resources/images/${usShow.img}"/>" alt="" /></a>
								<div class="time small-time show-time">
									<p>5:32</p>
								</div>
								<div class="clck show-clock">
							...
							<div class="resent-grid-info recommended-grid-info">
								<h5>
									<a href="single.html" class="title">${usShow.title}</a>
								</h5>
								<p class="author">
									<a href="#" class="author">John Maniya</a>
								</p>
				...
				<div class="recommended-grids">
					...
					<c:forEach var="indiaShow" items="${map.indiaShowList}">
						<div class="col-md-2 resent-grid recommended-grid show-video-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="single.html"><img
									src="<c:url value="/resources/images/${indiaShow.img}"/>"
									alt="" /></a>
								<div class="time small-time show-time">
									<p>5:09</p>
								</div>
							...
							<div class="resent-grid-info recommended-grid-info">
								<h5>
									<a href="single.html" class="title">${indiaShow.title}</a>
								</h5>
								<p class="author">
									<a href="#" class="author">John Maniya</a>
								</p>
				...
				<div class="recommended-grids">
					...
					<c:forEach var="thaiShow" items="${map.thaiShowList}">
						<div class="col-md-2 resent-grid recommended-grid show-video-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="single.html"><img
									src="<c:url value="/resources/images/${thaiShow.img}"/>" alt="" /></a>
								<div class="time small-time show-time">
									<p>5:09</p>
								</div>
								<div class="clck show-clock">
							...
							<div class="resent-grid-info recommended-grid-info">
								<h5>
									<a href="single.html" class="title">${thaiShow.title}</a>
								</h5>
								<p class="author">
									<a href="#" class="author">John Maniya</a>
								</p>
			...
			<div class="show-right-grids">
				<ul>
					<li class="tv-img"><a href="#"><img
							src="<c:url value="/resources/images/tv.png"/>" alt="" /></a></li>
